...
/*
	...
	*/
//responsivo mobile
function layoutResponsivo(w){
	console.log(w);
	if(w<800){
		console.log("mobile");
		$("#styleCSS").attr("href","css/mobile.css");
		$(".logo").attr("src","img/mobile/logo.png");
		$("body").attr("style","background-image:url('img/mobile/bg1.jpg')");
	}else{
		console.log("desktop");
		$("#styleCSS").attr("href","css/screen.css");
